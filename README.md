...
`notify-daily` 会为真实股票与 ETF 持仓先计算 MA/ATR/RSI/MACD/BOLL/KDJ、成交量、近期高低点、成本和仓位，再由确定性规则给出持有/观望/减仓/小幅加仓、买卖参考区间、失效位、目标位、仓位变化及置信度。Telegram 日报只展开最重要的最多 5 项，详细报告保留全部持仓。
